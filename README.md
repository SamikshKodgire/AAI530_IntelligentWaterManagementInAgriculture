...
Design a theoretical end-to-end IoT system architecture for smart irrigation

Perform data cleaning and exploratory data analysis (EDA) on soil moisture sensor data

Implement machine learning models, including time-series forecasting and deep learning

Visualize insights using a Tableau Public dashboard
...
The project includes two primary machine learning tasks:

Time-Series Forecasting to predict future soil moisture levels using historical data
...
Soil moisture sensors deployed in agricultural fields

Edge-level preprocessing and data aggregation
...
A Tableau Public dashboard presents:
...
Actionable irrigation insights
